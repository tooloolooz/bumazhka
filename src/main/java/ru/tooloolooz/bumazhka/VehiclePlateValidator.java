...
public final class VehiclePlateValidator {
    /**
     * Validator instance for any type vehicle registration plates.
     */
    private static final TypeAnyPlateValidator TYPE_ANY_PLATE_VALIDATOR = TypeAnyPlateValidator.INSTANCE;

    /**
     * Validator instance for 1 type vehicle registration plates.
     */
    private static final Type1PlateValidator TYPE_1_PLATE_VALIDATOR = Type1PlateValidator.INSTANCE;
