...
public final class TypeAnyPlateValidator implements PlateValidator {
    ...
    /**
     * Delegate validator for Type 1 plates.
     */
    private static final Type1PlateValidator TYPE_1_INSTANCE = Type1PlateValidator.INSTANCE;
    ...
    public boolean isValid(final String plate) {
        return TYPE_1_INSTANCE.isValid(plate);
    }
